...
// Fetch hotels in the specified city from the database
...
<head>
    ...
    <title>TravWiz - Hotels in <?php echo $cityName; ?></title>
</head>
<body>

<div class="navbar">
    <span class="logo">TravWiz</span>
</div>
...
<div class="content-container">
    ...
    if ($result->num_rows > 0) {
        ...
        while ($row = $result->fetch_assoc()) {
            ...
            // Add the "Book Now" button with the correct hotel ID link
...
<footer>
    <p>&copy; 2024 TravWiz. All rights reserved.</p>
</footer>

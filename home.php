...
<div class="box-container">
    ...
    <div class="box">
        ...
        <p>Booking my dream trip to the serene backwaters of Lahore was a breeze with TravWiz – seamless and stress-free! </p>
        <div class="user">
    ...
    <div class="box">
        ...
        <p>Thanks to TravWiz, I explored the majestic beauty of Lahore with ease, and the deals were unbeatable!</p>
        <div class="user">
    ...
    <div class="box">
        ...
        <p>Made my adventure to the mesmerizing Seaview unforgettable, with expert guidance and fantastic itineraries</p>
        <div class="user">
